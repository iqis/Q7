...
However, strictly speaking, Q7 uses more memory than R6. Q7 creates a separate copy of a member for every instance of an object, while in R7 they point to a common ancestor. But in most use cases this difference is negligible. Q7 is not expected to suffer from other performance deficiencies. 


In exchange, the portability issue is much easier to solve in Q7.
