...
`foo` stands for _Freestyle Object Oriented_ Programming, a fluid & powerful paradigm that has many creative uses, featuring:
...
- teach the user to manually rename existing bindings in time of collision
