...
`Q7` users can leave behind the grand narrative of the classical OOP orthodoxy, and exploit the benefits of objects simply as a unit of code, and as an instrument for namespace resolution.
